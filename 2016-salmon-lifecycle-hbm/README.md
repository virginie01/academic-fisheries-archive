...
4. **Cycle 3 (Multi-Regional Scaling):** Expansion into a multi-regional independent and dependent covariance matrix framework. Using Principal Component Analysis (PCA), this phase evaluated spatial synchrony, proving that population variations were highly synchronized across 5 out of the 6 geographic zones.
